...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — LuxeNova Community Wellness, Inc." },
      {
        name: "description",
        content:
          "Terms of Service for the LuxeNova Community Wellness, Inc. website and Request Help portal.",
      },
    ],
  }),
  component: TermsPage,
...
const sections = [
  {
    ...
    body:
      "By accessing or using the LuxeNova Community Wellness, Inc. website, Request Help portal, donor pages, or related services, you agree to be bound by these Terms of Service.",
  },
  {
  ...
  },
  {
    ...
    body:
      "All content on this site, including text, design, and branding, is the property of LuxeNova Community Wellness, Inc. and may not be reproduced without permission.",
  },
  {
    title: "Disclaimer",
    body:
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <PageHeader
          ...
          description="The terms that govern your use of LuxeNova Community Wellness, Inc. digital services."
        />
