...
export const Route = createFileRoute("/board-portal/cfo/donations")({
  head: () => ({ meta: [{ title: "Record Donation — Treasurer" }, { name: "robots", content: "noindex, nofollow" }] }),
...
function DonationsPage() {
  ...
  async function save() {
    ...
    if (form.id) await supabase.from("donations").update(payload).eq("id", form.id);
  ...
  return (
    <WorkspacePage
      ...
      subtitle="Log donations, track designations, and export for board reporting."
