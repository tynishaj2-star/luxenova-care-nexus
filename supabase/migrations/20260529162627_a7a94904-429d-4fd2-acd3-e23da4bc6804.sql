...
-- These are either trigger functions, RLS-internal helpers, or server-only utilities
-- invoked via the service_role; none should be callable from the PostgREST API.
...
-- Ensure service_role retains execute for server-side use
